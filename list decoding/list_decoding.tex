...
\begin{document}
	...
	\begin{definition}{}{}
		Given $0 \leq \rho <1$ and $L\geq1$, a code $\calc$ of block length $n$ over the alphabet $\Sigma$ is said to be $(\rho, L)$\emph{-list decodable} if for all $y\in\Sigma^n$,
		\[
		\#\{c\in\calc | \Delta(y,c)\leq\rho n\} \leq L.
		\]
	\end{definition}	
